...
namespace SistemaVentas.DAO.DBContext;
...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C67EED3F7");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FCBED22CE");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483099D77A2");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107202CB41D");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547ED13597A9");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1321A00479C");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76BF302DE3");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D87034E3D1");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEA963E9A0");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A63548C48D");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614EA8559C9");
